            ...
            child: new Column(
              children: <Widget>[
                ...
                new TextField(
                  ...
                  new Row(
                    children: <Widget>[
                      new Text("Jadwal Seminar Proposal :    ", style: new TextStyle(fontSize: 15,color: Colors.black),),
                        new DropdownButton(
                    onChanged: (value){
                      String _jadwal;(value);
                    },
                    value: _jadwal,
                  ...
                  new Row(
                    children: <Widget>[
                      new Text("Tempat Pelaksanaan :    ", style: new TextStyle(fontSize: 15,color: Colors.black),),
                        new DropdownButton(
                    onChanged: (value){
                    },
                    value: _tempat,
